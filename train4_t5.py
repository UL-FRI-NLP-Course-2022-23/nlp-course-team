...
from transformers import AutoTokenizer, TrainingArguments, Trainer, T5ForConditionalGeneration, Seq2SeqTrainingArguments, HfArgumentParser
...
tokenizer = AutoTokenizer.from_pretrained("cjvt/t5-sl-small", truncate=True)
